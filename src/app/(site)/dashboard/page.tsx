...
const SERVICE_ROUTES = {
  ...
  construction: '/real-estate/construction/dashboard',
} as const;
...
export default async function DashboardResolverPage({
  ...
  const dashboardServices = services.filter(
    (service): service is keyof typeof SERVICE_ROUTES =>
      service === 'travel' || service === 'real_estate' || service === 'construction',
  );
  ...
  return (
    <div className="charis-app-theme min-h-screen bg-background px-4 py-6 sm:px-6 sm:py-8">
