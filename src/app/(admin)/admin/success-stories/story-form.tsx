  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <Button type="submit" className={dashboardPrimaryButtonClass} disabled={isPending}>
          {isPending ? 'Saving...' : story ? 'Save story' : 'Create story'}
        </Button>
        <Button asChild type="button" variant="outline" className={`${dashboardButtonRadiusClass} bg-transparent`}>
