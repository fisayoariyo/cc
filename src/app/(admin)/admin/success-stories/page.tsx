...
import { dashboardOutlineButtonClass, dashboardPrimaryButtonClass } from '@/lib/dashboard-theme';
    ...
    <div className="space-y-8">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl space-y-2">
          <DashboardPageTitle as="h2">Success stories</DashboardPageTitle>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link
                      ...
                      className={`inline-flex items-center gap-2 ${dashboardOutlineButtonClass} px-3 py-2`}
                    >
                      Preview
