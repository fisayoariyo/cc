...
import { LazyCinematicHero as CinematicHero } from '@/components/landing/lazy-cinematic-hero';
...
export default function RealEstatePage({ featuredProperties }: { featuredProperties: PropertyRecord[] }) {
  const heroSlides = [
    {
      image: 'https://images.unsplash.com/photo-1762568702039-9ef749e06152?w=1280&q=75',
    ...
    {
      image: 'https://images.unsplash.com/photo-1775466989637-a142f04aa2ad?w=1280&q=75',
    ...
    {
      image: 'https://images.unsplash.com/photo-1775466989717-6ca5a1943c6a?w=1280&q=75',
