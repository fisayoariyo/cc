...
const AboutTeamGallery = dynamic(
  () => import('@/components/pages/about/about-team-gallery').then((m) => m.AboutTeamGallery),
  {
    ssr: false,
    loading: () => <div className="min-h-[50vh] animate-pulse bg-[#FEFAF4]" aria-hidden />,
  },
);
    ...
    <div className="min-h-screen bg-background pt-20">
      <section className="relative py-32 px-6 lg:px-8 bg-gradient-to-br from-background via-[#fff8f0] to-[#e8f6f1] overflow-hidden border-b border-border">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            <LandingHeroTitle tone="on-light" className="mb-6">
