...
export default function TravelPage() {
  const heroSlides = [
    {
      image: 'https://images.unsplash.com/photo-1768069794857-9306ac167c6e?w=1280&q=75',
    ...
    {
      image: 'https://images.unsplash.com/photo-1773829126358-1e5f4e5aa532?w=1280&q=75',
